...
public class MdPageGeneratorMojo extends AbstractMojo {
     ...
     *
     * @return boolean Is there files to read
    ...
    private String getTitle(List<String> raw) {
        ...
        getLog().debug("Could not find title, returning default: " + defaultTitle);
        return defaultTitle;
    }
    ...
    /**
     * Update relative include paths corresponding to the markdown file's
